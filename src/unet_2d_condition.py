...
from .unet_2d_blocks import (
    CrossAttnDownBlock2D_wjj,
    CrossAttnUpBlock2D_wjj,
    DownBlock2D,
    UNetMidBlock2DCrossAttn_wjj,
    UpBlock2D,
    get_down_block,
    get_up_block,
)
...
class UNet2DConditionModel_with_patch_wjj_inpaint(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def __init__(
        ...
        mid_block_type: Optional[str] = "UNetMidBlock2DCrossAttn_wjj",
        up_block_types: Tuple[str] = ("UpBlock2D", "CrossAttnUpBlock2D_wjj", "CrossAttnUpBlock2D_wjj", "CrossAttnUpBlock2D_wjj"),
        ...
        # mid
        if mid_block_type == "UNetMidBlock2DCrossAttn_wjj" or mid_block_type == "UNetMidBlock2DCrossAttn":
            self.mid_block = UNetMidBlock2DCrossAttn_wjj(
        ...
        self.referenceEncoder_v2_ = PatchEncoder_v2()
    ...
    def _set_gradient_checkpointing(self, module, value=False):
        if isinstance(module, (CrossAttnDownBlock2D_wjj, DownBlock2D, CrossAttnUpBlock2D_wjj, UpBlock2D)):
    ...
    def get_input_v3(self, latent_bg_for_inpaint, mask, stroke_seg_1, stroke_seg_1_no, con_flag=True):
        ...
        if stroke_seg_1 is not None:
            fg_reference_v2 = self.referenceEncoder_v2_(stroke_seg_1)#, self.pos_2(stroke_seg_1))

        if con_flag == False:
            fg_reference_v2_no = self.referenceEncoder_v2_(stroke_seg_1_no)#, self.pos_2(stroke_seg_1_no))
        #memory_2 = mask
        memory_2 = torch.cat([latent_bg_for_inpaint, mask], 1)

        return memory_2, fg_reference_v2, fg_reference_v2_no

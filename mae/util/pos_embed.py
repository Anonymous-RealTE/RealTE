...
def interpolate_pos_embed(model, checkpoint_model):
    ...
    if 'pos_embed' in checkpoint_model:
        ...
        new_size_h = int(32/16)
        new_size_w = int(640/16)

   
        if orig_size != new_size_h:
            print("Position interpolate from %dx%d to %dx%d" % (orig_size, orig_size, new_size_h, new_size_w))
    ...
    if 'decoder_pos_embed' in checkpoint_model:
        ...
        if orig_size != new_size_h:
            ...
            print(checkpoint_model['decoder_pos_embed'].shape)    
